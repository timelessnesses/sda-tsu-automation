/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c63edd825591143cac012d130dbc4e14)
// Runtime types generated with workerd@1.20260702.1 2026-07-09 nodejs_compat
interface __BaseEnv_Env {
	FUCK_YOU_SDA_KV: KVNamespace;
	Proxying: Fetcher;
	FUCK: BrowserRun;
	SDA_USERNAME: string;
	SDA_PASSWORD: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, 'SDA_USERNAME' | 'SDA_PASSWORD' | 'DISCORD_WEBHOOK'>> {}
}
